...
public class VillagerToGuard 
{
	...
	guard.setLocationAndAngles(villagerentity.getPosX(), villagerentity.getPosY(), villagerentity.getPosZ(), villagerentity.rotationYaw, villagerentity.rotationPitch);
