...
public class GuardModel extends BipedModel<GuardEntity> {
    public RendererModel bipedRightLegDagger;
    public RendererModel bipedLeftArmShoulderPad;
    public RendererModel bipedRightArmShoulderPad;
    ...
    public GuardModel(float f) {
        ...
        this.bipedRightArm = new RendererModel(this, 32, 75);
        this.bipedRightArm.mirror = true;
        this.bipedRightArm.setRotationPoint(-5.0F, 2.0F, 0.0F);
        this.bipedRightArm.addBox(-3.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F);
        this.bipedRightLeg = new RendererModel(this, 16, 28);
        this.bipedRightLeg.setRotationPoint(1.9F, 12.0F, 0.0F);
        this.bipedRightLeg.addBox(-2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F);
        this.setRotateAngle(bipedRightLeg, -0.045553093477052F, 0.0F, 0.0F);
        this.bipedRightLegDagger = new RendererModel(this, 35, 71);
        ...
        this.bipedLeftArm = new RendererModel(this, 33, 48);
        this.bipedLeftArm.setRotationPoint(5.0F, 2.0F, 0.0F);
        this.bipedLeftArm.addBox(-1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F);
        this.bipedHead = new RendererModel(this, 49, 99);
        this.bipedHead.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.bipedHead.addBox(-4.0F, -10.0F, -4.0F, 8, 10, 8, 0.0F);
        this.bipedLeftArmShoulderPad = new RendererModel(this, 72, 33);
        ...
        this.bipedRightArmShoulderPad = new RendererModel(this, 40, 20);
        ...
        this.bipedBody = new RendererModel(this, 52, 50);
	...
	public void setRotationAngles(GuardEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netbipedHeadYaw, float bipedHeadPitch, float scaleFactor) 
	{
		super.setRotationAngles(entityIn, limbSwing, limbSwingAmount, ageInTicks, netbipedHeadYaw, bipedHeadPitch, scaleFactor);
