...
public class VillagerGuard <T extends GuardEntity> extends SegmentedModel<T> implements IHasArm {
	...
	public VillagerGuard() {
		...
		this.Head.addCuboid(-4.0F, -10.0F, -4.0F, 8, 10, 8, 0.0F);
		this.LegL = new ModelRenderer(this, 16, 48);
		this.LegL.setRotationPoint(1.9F, 12.0F, 0.0F);
		this.LegL.addCuboid(-2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F);
		...
		this.ArmShoulderPadL.addCuboid(-7.0F, 0.0F, -3.5F, 7, 0, 7, 0.0F);
		...
		this.ArmShoulderPadR.addCuboid(0.1F, 0.0F, -3.5F, 7, 0, 7, 0.0F);
	...
	public void setLivingAnimations(T entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
	      this.swingProgress = (float)entityIn.getItemInUseMaxCount();
	      super.setLivingAnimations(entityIn, limbSwing, limbSwingAmount, partialTick);
	   }
	
	  public void setArmAngle(HandSide p_225599_1_, MatrixStack p_225599_2_) {
