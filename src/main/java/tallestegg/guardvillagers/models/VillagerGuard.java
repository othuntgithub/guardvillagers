...
public class VillagerGuard extends EntityModel<GuardEntity> implements IHasArm, IHasHead {
    ...
    @Override
    public void render(GuardEntity entityIn, float f, float f1, float f2, float f3, float f4, float f5) { 
